...
if(ref1==1)
{
s1.executeUpdate("delete from employee where employee_id=" + "'" +
t1.getText() + "'");

s1.executeUpdate("insert into employee values('" + t1.getText() + "','" + t2.getText() + "','" + t3.getText() + "','" + t4.getText() + "','" + t5.getText() + "','" + t6.getText() + "','" + t7.getText() + "','" + t8.getText() + "','" + t9.getText() + "')" );

jp.showMessageDialog(this,"The Employee ID " + t1.getText() + " has been updated");
...
{
jp.showMessageDialog(this,"Search for his/her Details first and confirm if you wanna update in the Employee ID " + t1.getText());
}
ref1=0;
}
catch(Exception r)
...
if(ref1==0)
{
jp.showMessageDialog(this,"The employee ID " + t1.getText() + " doesn't exists");
}
