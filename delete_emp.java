...
public class delete_emp extends JFrame implements ActionListener
{
int ref1=0;
...
jp.showMessageDialog(this,"The Employee ID " + t1.getText() + " has been deleted");
...
{
jp.showMessageDialog(this,"Search for his Details first and confirm if you wanna delete the Employee ID " + t1.getText());
}
ref1=0;
}
catch(Exception r)
